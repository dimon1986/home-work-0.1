...
class Button(Widget):
    """Класс кнопки"""
    def __init__(self, screen, the='btn', txt='',
                 # цвета кнопки, текста, прямоугольника
...
class Label(Widget):
    ...
    """
    def __init__(self, screen, the='lbl', txt='', link=None,
                 # цвета лейбла, текста, прямоугольника
                 bg_color=None, hover_bg_color=None, act_bg_color=None,
                 txt_color='black', hover_txt_color=None, act_txt_color=None,
                 border_color=None, hover_border_color=None, act_border_color=None,
                 # шрифт и его размер
...
class Image(Widget):
    ...
    Атрибуты: индекс - номер картинки,
    кулдаун- сколько раз должны обновляться.
    ...
    def gen_img(self):
        for k, v in self.dict_images.items():
            ...
            # укрупняю картинку
            self.area = pygame.transform.scale(image, (200, 200))
    ...
    def enumeration(self):
        ...
        self.area = pygame.transform.scale(img, (200, 200))
